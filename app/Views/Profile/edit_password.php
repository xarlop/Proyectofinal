...
<div class="container">
    ...
    <?= form_open("/profile/updatepassword") ?>
        ...
        <div class="field">
            ...
            lang('Profile.current_password') ?></label>
            <input class="input" type="password" name="current_password">
        </div>
        
        <div class="field">
            <label class="label" for="password"><?=
             lang('Profile.new_password') ?></label>
            <input class="input" type="password" name="password">
        </div>
        
        <div class="field">
            <label class="label" for="password_confirmation"><?= 
            lang('Profile.repeat_new_password') ?></label>
        ...
        <div class="field is-grouped">
            ...
            <div class="control">
                <a class="button" href="<?= site_url("/profile/show") ?>"><?= 
                lang('Profile.cancel') ?></a>
            </div>
        </div>
